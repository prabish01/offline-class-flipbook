...
# Image-based exercises (these use images, not text questions)
# Format: (chapter_id, exercise_letter): instruction_text
IMAGE_EXERCISES = {
...
def parse_question_bank(filepath):
    ...
    while i < len(lines):
        ...
        # Check for exercise header (A – instruction)
...
def save_exercise(chapters, chapter_num, exercise, instruction, questions, chapter_name):
    ...
    if (chapter_id, exercise) in IMAGE_EXERCISES:
        ...
        img_path = f'../../../assets/images/test-generator/class-6/Grammar - Chapter {chapter_num} {exercise}.png'
...
if __name__ == '__main__':
    txt_file = '/Users/prabishdangi/Desktop/Personal/SilverStone Captial/offline-flipbook/class6-question-bank.txt'
    ...
    # Save to file
    output_file = '/Users/prabishdangi/Desktop/Personal/SilverStone Captial/offline-flipbook/class6-questionbank-generated.js'
